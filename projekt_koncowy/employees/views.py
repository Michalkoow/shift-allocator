...
# Lista pracowników z wyszukiwaniem, sortowaniem i paginacją
...
# Przydzielanie pracowników (algorytm)
@login_required
...
# Lista przydziałów z filtrowaniem po dacie i paginacją
@login_required
